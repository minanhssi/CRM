...
const KIND_STYLES: Record<Kind, { bg: string; text: string; label: string }> = {
  ...
  problem: { bg: "bg-[#D8433D]/10", text: "text-[#B7332E]", label: "PROBLEM" },
  approach: { bg: "bg-port-accent/10", text: "text-port-accent", label: "APPROACH" },
  output: { bg: "bg-[#109C84]/10", text: "text-[#109C84]", label: "OUTPUT" },
  reflection: { bg: "bg-[#8A5FD6]/10", text: "text-[#7A4FC6]", label: "REFLECTION" },
};
